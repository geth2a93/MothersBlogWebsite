...
def get_home_latest_content():
    ...
    if latest_book:
        data["book"] = {
            ...
            "genre_name": [normalize_genre(g.genre) for g in latest_book.genres],
    ...
    for genre in Genre.query.order_by(Genre.genre).all():
        ...
        if b:
            data.append({
                ...
                "title": b.title,
                "genre": genre.genre,
                "genre_name": [normalize_genre(g.genre) for g in b.genres],
                "slug": b.slug,
                "synopsis": b.synopsis,
...
def get_books_by_title(slug, published):
    ...
    data = {
        ...
        "genre_name": [normalize_genre(g.genre) for g in book.genres],
